...
/**
 * Read-only audit log endpoint. There is deliberately no POST/PUT/DELETE endpoint here -
 * audit entries are only ever written internally via {@link AuditLogService#log}.
 */
@RestController
