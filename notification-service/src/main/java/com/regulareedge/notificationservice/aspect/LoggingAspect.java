package com.regulareedge.notificationservice.aspect;
...
public class LoggingAspect {
    ...
    @Around("execution(* com.regulareedge.notificationservice.controller..*(..)) || "
            + "execution(* com.regulareedge.notificationservice.service.implementation..*(..))")
