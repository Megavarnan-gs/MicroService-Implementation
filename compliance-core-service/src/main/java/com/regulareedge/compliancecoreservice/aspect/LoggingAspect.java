package com.regulareedge.compliancecoreservice.aspect;
...
public class LoggingAspect {
    ...
    @Around("execution(* com.regulareedge.compliancecoreservice.controller..*(..)) || "
            + "execution(* com.regulareedge.compliancecoreservice.service.implementation..*(..))")
