package com.regulareedge.auditanalyticsservice.aspect;
...
public class LoggingAspect {
    ...
    @Around("execution(* com.regulareedge.auditanalyticsservice.controller..*(..)) || "
            + "execution(* com.regulareedge.auditanalyticsservice.service.implementation..*(..))")
