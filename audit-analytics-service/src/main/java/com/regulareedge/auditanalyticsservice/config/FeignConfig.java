package com.regulareedge.auditanalyticsservice.config;

import com.regulareedge.auditanalyticsservice.common.constants.AppConstants;
import com.regulareedge.auditanalyticsservice.common.constants.SecurityConstants;
...
public class FeignConfig {
     ...
     * Feign calls so downstream services (e.g. return-management-service,
     * compliance-core-service) see the same caller context and requests remain
