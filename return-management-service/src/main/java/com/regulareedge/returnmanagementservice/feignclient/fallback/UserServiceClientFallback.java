...
import com.regulareedge.returnmanagementservice.feignclient.UserServiceClient;
 ...
 * operations (creating returns, schedules, submissions, correspondence, penalties, etc.).
 * This is an intentional, documented architecture decision - not a bug - until auth-service
 * adds real support for this lookup. Every fallback invocation is logged at WARN so the
 * gap stays visible.
 */
@Component
