...
import com.regulareedge.returnmanagementservice.common.constants.AppConstants;
import com.regulareedge.returnmanagementservice.common.constants.SecurityConstants;
...
public class FeignConfig {
     ...
     * Feign calls so downstream services (e.g. auth-service, compliance-core-service) see
     * the same caller context and requests remain traceable end-to-end.
     */
    @Bean
