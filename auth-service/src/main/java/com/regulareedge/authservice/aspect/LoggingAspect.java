package com.regulareedge.authservice.aspect;
...
public class LoggingAspect {
    ...
    @Around("execution(* com.regulareedge.authservice.controller..*(..)) || "
            + "execution(* com.regulareedge.authservice.service.implementation..*(..))")
